...
ifeq ($(GOOS),)
	...
	go build -ldflags "-X main.BuildNo=$$BUILD_NUMBER -X main.GitCommit=$$GitCommit -X main.Tag=$$GitTag -X main.BuildTime=$$BuildTime -X main.Authors=$$Authors" -o $(FNAME) main.go
